  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-black text-dark">{t('loginTitle')}</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          <div className="text-right mt-1.5">
            <a href="#" className="text-xs text-brand-pink hover:underline font-medium">
              {t('forgotPassword')}
            </a>
          </div>
        </div>
      ...
      <p className="text-center text-sm text-muted mt-6">
        {t('noAccount')}{' '}
        <Link href="/auth/register" className="text-brand-pink font-semibold hover:underline">
          {t('signUp')}
        </Link>
      </p>
    </div>
